...
func importUser() -> [User] {
    var users: [User] = []
    users.append(User("guest", "Guest", "", [1, 2, 3, 4, 5, 6], [25, 27, 28, 31], [46], [13, 23], "BEng(EE)"))
    users.append(User("hkwdrawoh", "Howard Wan", "hkwdrawoh", [1, 2, 3, 4, 5, 6], [25, 27, 28, 31], [46], [13, 23], "BEng(ElecE)"))
    return users
}
